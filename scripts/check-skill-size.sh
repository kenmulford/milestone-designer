...
#   description: field must stay at or under ~200 words. A written size
#   standard with no enforcing gate is exactly how a SKILL.md silently regrows
#   past its target — this script is the enforcement that closes that gap.
#
...
# check idiom below needs no nullglob shopt and no array-of-matches.
#
